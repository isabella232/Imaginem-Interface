...
export default class LandingContent extends Component {
    render() {        
        return (
            <div>
                <div>
                    <h1>Welcome to Imàginem (Latin for image)</h1>
                    <h3>Imàginem is an open source, serverless framework for processing images through a number of computer vision classifiers, including face recognition and matching.</h3>
                </div>
                <br/>
                <br/>
                <div className="content">
                    <p>
                        When we set out to build Imàginem, we wanted it to be easy to configure, deploy and customize. That is why Imàginem is built on the <a href="https://azure.microsoft.com/en-us/services/functions/">Azure Functions</a> serverless framework. 
                    ...
                    <p>
                        If you're interested in using Imàginem, please feel free to check out the <a href="/#/upload">demo</a> and clone the GitHub <a href="https://github.com/CatalystCode/Imaginem">repository</a>.
                    </p>
                </div>
            </div>
      );
